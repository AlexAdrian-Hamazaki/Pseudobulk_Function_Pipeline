...
process makeCTProfiles {
    publishDir "${params.publish}/${bootstrap}/CTProfiles", mode: 'symlink'
...
process graphSparsity {
    publishDir "${params.publish}/${ch_bootstraps}/graphs", mode: "symlink"
    conda params.python3_9
...
process simBulk {
    ...
    executor "local"
    maxForks 32
    publishDir "${params.publish}/${ch_bootstraps}/simulations/${variance_ch}/${cell_type_profiles_csv}", mode: "symlink"
    conda params.python3_9
...
process sim_bulk_EGAD {
    ...
    publishDir "${params.publish}/${ch_bootstraps}/EGAD/${expression_matrix.getBaseName()}", mode: 'symlink'
...
process getSimulationStats {
    publishDir "${params.publish}/${ch_bootstraps}/stats/avg_composition/${variance_ch}/${expression_matrix.getBaseName()}", mode: "symlink"
    conda params.python3_9
...
process graphSimulationComposition {
    ...
    publishDir "${params.publish}/${ch_bootstraps}/graphs/${variance_ch}/${op_name}", mode: "symlink"
    conda params.python3_9
...
process graphAverageComposition {
    ...
    publishDir "${params.publish}/${ch_bootstraps}/graphs/average_composition/${organism_part_name}", mode: "symlink"
    conda params.python3_9
...
process makeMeltedDF {
    ...
    publishDir "${params.publish}/${ch_bootstraps}/EGAD/melted_dfs/", mode: "symlink"
    conda params.python3_9
...
workflow pipe {
    ...
    main:
        ...
        CH_ct_profiles = makeCTProfiles.out
